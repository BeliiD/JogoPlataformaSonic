                ...
                if ( c >= 'A' && c <= 'Z' ) {
                    ...
                    switch ( c ) {
                        ...
                        case 'e': 
                            ...
                            item->objeto = criarItemEscudo( 
                                ...
                                BLUE // Cor do bounding box/padrão do escudo
                            );
                        ...
                        case 's': // 
                            ...
                            item = criarItem( TIPO_ITEM_ESTRELA ); 
                             ...
                             item->objeto = criarItemEstrela( 
                                 (Rectangle) { 
                                     .x = novoMapa->dimensaoPadraoElementos * colunaAtual - 6, 
                                     .y = novoMapa->dimensaoPadraoElementos * linhaAtual, 
                                     .width = 50, 
                                     .height = 50
                                 },
                                 GOLD // Cor do bounding box/padrão da estrela
                             );
                        ...
                        case 'p':
                            ...
                            item = criarItem( TIPO_ITEM_PLACAFIM );

                            item->objeto = criarItemPlacaFim(
                                (Rectangle) {
                                    .x = novoMapa->dimensaoPadraoElementos * colunaAtual - 24,
                    ...
                    switch ( c ) {
                        ...
                        case '1':
                            ...
                            inimigo = criarInimigo( TIPO_INIMIGO_BUZZ_BOMBER );

                            inimigo->objeto = criarInimigoBuzzBomber( 
                                (Rectangle) { 
                                    .x = novoMapa->dimensaoPadraoElementos * colunaAtual, 
                                    .y = novoMapa->dimensaoPadraoElementos * linhaAtual - 10, 
                                    .width = 90, 
                                    .height = 38
                                },
                                YELLOW
                        ...
                        case '2':
                            ...
                            inimigo->objeto = criarInimigoCrabmeat( 
                                (Rectangle) { 
                                    .x = novoMapa->dimensaoPadraoElementos * colunaAtual, 
                                    .y = novoMapa->dimensaoPadraoElementos * linhaAtual - 28, 
                                    .width = 96, 
                                    .height = 76
                                },
                                YELLOW
